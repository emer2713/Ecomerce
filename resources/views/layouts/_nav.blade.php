<div class="header-nav animate-dropdown">
    <div class="container">
        ...
        <span class="sr-only">Ch’uhuk Tradition</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
            </div>
            <div class="nav-bg-class">
                <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                    <div class="nav-outer">
                        <ul class="nav navbar-nav">
                            <li class="active dropdown"> <a href="{{ route('web.index') }}">Home</a> </li>

                            @foreach ($categorias as $categoria)
                                @if ($categoria->front == 'YES')
                                <li class="dropdown yamm mega-menu">
                                <a href="#" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">{{$categoria->name}}</a>
