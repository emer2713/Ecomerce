          ...
          <div class="module-body">
            <ul class="toggle-footer" style="">
              ...
              <li class="media">
                ...
                <div class="media-body"> <span><a href="#">front@themesground.com</a></span> </div>
              </li>
            </ul>
          </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-4 no-padding">
        <div class="clearfix payment-methods">
          <ul>
            <li><img src="front/assets/images/payments/1.png" alt=""></li>
            <li><img src="front/assets/images/payments/2.png" alt=""></li>
            <li><img src="front/assets/images/payments/3.png" alt=""></li>
            <li><img src="front/assets/images/payments/4.png" alt=""></li>
